...
//
// Source of truth: dashboard/data.js + _workspace/predictions.json (2026-06-09).
// ============================================================================
...
export const DRIVER_INFO = {
  ...
  max_verstappen: { name: "Max Verstappen",      short: "VER", team: "red_bull",     team_name: "Red Bull Racing",  color: "#3671C6", number: 1 },
...
export const REGULATION_IMPACT_2026 = {
  ...
  constructor_competitiveness_change: {
    red_bull: -5, ferrari: 8, mclaren: 3, mercedes: 5, aston_martin: -2,
    williams: 1, alpine: -3, rb: -1, haas: 0, sauber: -2,
  },
};

// Frozen 2026 base finishing-position prediction from the trained XGBoost model
// (predictions.json base_predicted_position). predict.js uses this as the prior
// when no live 2026 results exist, and blends live standings in as races complete.
export const MODEL_BASE_2026 = {
  ...
  tsunoda: 16, stroll: 17, hulkenberg: 18, doohan: 19, bortoleto: 20,
};
...
export const HISTORICAL_DRIVER_POINTS = {
  ...
  2024: { albon: 2, alonso: 44, bearman: 6, gasly: 7, hamilton: 79, hulkenberg: 10, leclerc: 164, magnussen: 2, norris: 154, ocon: 3, perez: 127, piastri: 96, ric: 16, russell: 83, sainz: 130, sar: 1, stroll: 15, tsunoda: 20, verstappen: 251, zho: 2 },
...
export const DRIVER_ROLLING_FORM = {
  ...
  tsunoda:        { seasons: SEASONS_USED, points: [0, 2, 10, 6, 20, 2] },
  ...
  doohan:         { seasons: SEASONS_USED, points: [0, 0, 0, 0, 0, 0] },
  bortoleto:      { seasons: SEASONS_USED, points: [0, 0, 0, 0, 0, 0] },
};

// 2026 race calendar (round → {id, name, date ISO}). Used for cron self-gating
// (only do the heavy fetch on race weekends) and the dashboard timeline.
export const CALENDAR_2026 = [
  { round: 1,  id: "australia",   name: "Australian GP",     date: "2026-03-08" },
  { round: 2,  id: "china",       name: "Chinese GP",        date: "2026-03-15" },
  { round: 3,  id: "japan",       name: "Japanese GP",       date: "2026-03-29" },
  { round: 4,  id: "bahrain",     name: "Bahrain GP",        date: "2026-04-12" },
  { round: 5,  id: "saudi_arabia",name: "Saudi Arabian GP",  date: "2026-04-19" },
  { round: 6,  id: "miami",       name: "Miami GP",          date: "2026-05-03" },
  { round: 7,  id: "canada",      name: "Canadian GP",       date: "2026-05-24" },
  { round: 8,  id: "monaco",      name: "Monaco GP",         date: "2026-06-07" },
  { round: 9,  id: "spain",       name: "Spanish GP",        date: "2026-06-14" },
  { round: 10, id: "austria",     name: "Austrian GP",       date: "2026-06-28" },
  { round: 11, id: "britain",     name: "British GP",        date: "2026-07-05" },
  { round: 12, id: "belgium",     name: "Belgian GP",        date: "2026-07-19" },
  { round: 13, id: "hungary",     name: "Hungarian GP",      date: "2026-07-26" },
  { round: 14, id: "netherlands", name: "Dutch GP",          date: "2026-08-23" },
  { round: 15, id: "italy",       name: "Italian GP",        date: "2026-09-06" },
  { round: 16, id: "spain",       name: "Madrid GP",         date: "2026-09-13" },
  { round: 17, id: "azerbaijan",  name: "Azerbaijan GP",     date: "2026-09-27" },
  { round: 18, id: "singapore",   name: "Singapore GP",      date: "2026-10-11" },
  { round: 19, id: "americas",    name: "United States GP",  date: "2026-10-25" },
  { round: 20, id: "mexico",      name: "Mexico City GP",    date: "2026-11-01" },
  { round: 21, id: "brazil",      name: "São Paulo GP",      date: "2026-11-08" },
  { round: 22, id: "las_vegas",   name: "Las Vegas GP",      date: "2026-11-21" },
  { round: 23, id: "qatar",       name: "Qatar GP",          date: "2026-11-29" },
  { round: 24, id: "abu_dhabi",   name: "Abu Dhabi GP",      date: "2026-12-06" },
];
